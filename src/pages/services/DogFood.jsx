...
const DogFood = () => {
  ...
  const foodItems = [
    { name: 'Chicken Meal', description: 'Healthy chicken-based food.', price: 250 }, 
    { name: 'Egg Meal', description: 'Nutritious egg meal for your dog.', price: 150 },
    { name: 'Vegetarian Meal', description: 'Grain-free vegetarian food.', price: 150 },
  ];
